/* NOTE(elsuizo:2020-05-06): este archivo lo saque de la pagina Rosetta code:
 * http://rosettacode.org/wiki/Password_generator#C */
/* me parecio una implementacion limpia y bien hecha */
